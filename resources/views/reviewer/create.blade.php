    ...
    <div class="row mt-3 mb-3">
        <div class="col-lg-12 margin-tb">
            <div class="col-lg-12 margin-tb mb-4 text-center">
                <h2>Form Tambah Reviewer</h2>
            </div>
            <form action="{{ route('reviewer-simpan') }}" method="POST">
                @csrf
                <div class="mb-3">
                    <label for="namaReviewer" class="form-label">Nama Beserta Gelar</label>
                    <input type="text" class="form-control" id="namaReviewer" name="namaReviewer">
                </div>
                <div class="mb-3">
                ...
                <div class="mt-5">
                    <button type="submit" class="btn btn-primary col-sm-12">Tambahkan</button>
                </div>
            </form>
            <div class="mt-3">
